...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.GET, Arrays.asList(new ResponseMessageBuilder()
						...
						new ResponseMessageBuilder()
						.code(404)
						.message("O recurso quer você buscou não foi encontrado.")
						.build()))
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				...
				.description("Esta é uma documentação interativa da Rest do forum da Alura. Tente enviar algum request ;)")
				.version("1.0")
				.contact(contato)
				.build();
	}
